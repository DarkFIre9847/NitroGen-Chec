...
class NitroGen:
    ...
    def main(self):
        ...
        if os.name == "nt": 
            print("")
            ctypes.windll.kernel32.SetConsoleTitleW("Nitro Generator and Checker - Made by Dark Fire")
        else:
            print(f'\33]0;Nitro Generator and Checker - Made by Dark Fire#5280\a', end='', flush=True)
...
▀▀▀▀▀•  ▀  ▀ .▀  ▀·▀  ▀    ▀▀▀ ▀▀▀.▀  ▀ ▀▀▀ 
                                                        ...
                                                        """) 
        time.sleep(2)
        self.slowType("Made by Dark Fire#5280", .03)
        time.sleep(1)
        ...
        for i in range(num):
            ...
            if os.name == "nt":
                ctypes.windll.kernel32.SetConsoleTitleW(f"Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by Dark Fire")
                print("")
            else:
                print(f'\33]0;Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by Dark Fire#5280\a', end='', flush=True)
...
Results:
 ...
 Valid Codes: {', '.join(valid )}""")
        ...
        input("\nThe end! Press Enter 5 times to end the program.")
